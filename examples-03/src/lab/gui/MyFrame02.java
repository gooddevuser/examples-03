...
public class MyFrame02 extends JFrame {
	...
	public MyFrame02() {
		...
		button.setLocation(
				( getWidth() - button.getWidth()) / 2, 
				( (getHeight() - 50) - button.getHeight() ) / 2);
	...
	class ClickHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {			
			...
			//              생성자 메서드에 red, green, blue 값을 전달해야 합니다.
			//              red, green, blue는 0 ~ 256 범위의 정수 또는 0 ~ 1 범위의 실수
			Color color = new Color(r, g, b); //
			
			//MyFrame02.this : 현재 클래스를 포함하는 외부 클래스들 중에서 MyFrame02 객체의 참조
